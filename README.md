...
### ```프로젝트 목표: AI 산업의 취업을 희망하는 구직자에게 채용 관련 데이터 및 서비스 제공```
![image](https://github.com/user-attachments/assets/854c229f-d71f-41fa-9514-121bb3a8bb9b)

## 주제 선정 배경

![image](https://github.com/user-attachments/assets/0969a630-bc6c-4dd7-8f7f-2d6687ea93e3)
![image](https://github.com/user-attachments/assets/854c229f-d71f-41fa-9514-121bb3a8bb9b)
...
|----------------|--------------------------------------------------------------|
| **아이콘**     | 1. 카테고리별 아이콘을 다르게 시각화<br>2. 아이콘 클릭시 기업 정보 표시           |
...
- 처음 목표로 했던 AI 구직자들이 궁금해할만한 흥미로운 주제에 대한 분석 결과와 AI 기업 정보 제공 서비스 프로토타입을 제작할 수 있었다.
